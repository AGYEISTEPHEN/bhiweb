...
<section class="hero" id="home">
  <div class="hero-content">
    <div class="hero-badge">Bono Region, Ghana Â· Founded 2026</div>
    <h1>Heart Care Should Not Depend<br>on <em>Where You Live.</em></h1>
    <p class="hero-sub">
      Bono Heart Initiative addresses the full Cardio-Metabolic-Renal continuum â€”
      heart disease, diabetes, obesity, and kidney disease â€” bringing specialist
      detection closer to every community across the Bono Region of Ghana.
    </p>
    <div class="hero-ctas">
      <a href="#outreach" class="btn-primary" onclick="document.getElementById('outreach').scrollIntoView({behavior:'smooth'}); return false;">ðŸ©º Get Screened</a>
      <a href="#partners" class="btn-secondary">Support the Mission</a>
    </div>
    <p class="hero-link">
      Are you a health professional?
      <a href="#refer">Refer a Patient â†’</a>
    </p>
    <div class="hero-trust">
      <div class="trust-item">Led by a qualified cardiologist</div>
      <div class="trust-item">Sunyani Teaching Hospital</div>
      <div class="trust-item">CMR Strategic Plan 2026â€“2028</div>
      <div class="trust-item">Longitudinal CMR registry</div>
    </div>
  </div>
  <div class="scroll-indicator">â†“ scroll</div>
</section>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub">
        ...
        arrive separately â€” they form one interconnected disease continuum, and most people do not know
        they are on it until it is too late.
      </p>
    </div>
    <div class="stat-cards reveal">
      <div class="stat-card">
        <div class="stat-number">30â€“40%</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-label">
          ...
          Uncontrolled blood sugar damages the heart, blood vessels, and kidneys simultaneously â€” accelerating the CMR cascade.
        </div>
      </div>
      <div class="stat-card">
        ...
        <div class="stat-label">
          ...
          Presenting when structural damage is already irreversible â€” almost always the endpoint of years of unmanaged CMR disease.
        </div>
      </div>
    </div>
  </div>
...
<section class="why-bono" id="why-bono">
  <div class="container">
    ...
    <h2 class="section-title">The Bono Region carries a full CMR burden â€” with none of the infrastructure.</h2>
    ...
    <div class="bono-facts reveal">
      ...
      <div class="bono-fact">
        ...
        <div class="bono-fact-label">Estimated hypertension prevalence â€” most undiagnosed, untreated, and progressing</div>
      </div>
      <div class="bono-fact">
        <div class="bono-fact-value">Rising</div>
        <div class="bono-fact-label">Diabetes and obesity burden â€” driven by dietary transition and sedentary urbanisation in district capitals</div>
      </div>
      <div class="bono-fact">
        <div class="bono-fact-value">2â€“3 hrs</div>
        <div class="bono-fact-label">To the nearest specialist cardiac diagnostic centre â€” leaving most Bono Region residents without access to timely cardiovascular investigation.</div>
      </div>
      <div class="bono-fact">
        <div class="bono-fact-value">GHS 300</div>
        <div class="bono-fact-label">Transport cost per referral â€” prohibitive for most farming and trading families</div>
      </div>
      <div class="bono-fact">
    ...
    <div class="founder-grid reveal">
      <div class="founder-image-col">
        <div class="founder-photo-wrap">
          ...
          <div class="founder-nameplate">
            ...
            <div class="founder-title">Consulting Cardiologist Â· Founder, Bono Heart Initiative</div>
      ...
      <div class="founder-content-col">
        ...
        <p class="founder-body">
          Bono Heart Initiative was born from a journey that crossed communities, countries, and healthcare systems â€” but always returned to one central question: why should access to specialist care depend on geography?
        </p>
        <p class="founder-body">
          Its founder, Dr. Edward Bediako Mensah, began his medical training at the <strong>Latin American School of Medicine (ELAM) in Cuba</strong> â€” a globally recognised institution founded on the principles of equity, prevention, and service to underserved communities. At ELAM, physicians were taught to engage communities directly, identify disease early, and bring care closer to those who needed it most.
        </p>
        <p class="founder-body">
          He then pursued specialist cardiology training at the <strong>Cardiocentro Ernesto Che Guevara in Santa Clara, Cuba</strong> â€” one of the country's leading cardiovascular centres â€” gaining advanced experience in echocardiography, heart failure, structural heart disease, and preventive cardiology. There, a pattern became clear: many patients presenting with advanced cardiovascular disease could have been identified far earlier if effective detection systems had existed closer to home.
        </p>
        <blockquote class="founder-quote">
          "Many of the patients presenting with advanced cardiovascular disease could have been identified much earlier â€” if effective systems for detection and follow-up had existed closer to where they lived."
        </blockquote>
        <p class="founder-body">
          His training is currently being further deepened through the <strong>Postgraduate Course in Heart Failure (PCHF) at University Hospital Zurich</strong> â€” with the Certificate of Advanced Studies (CAS) expected in 2027 â€” where he is learning how sustainable cardiovascular systems are built through registries, outcomes measurement, and implementation science.
        </p>
        <p class="founder-body">
        ...
        <a href="#" onclick="switchPage('founder'); return false;" class="founder-link">
          Meet Dr. Bediako Mensah â€” Full Story â†’
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub" style="color:rgba(255,255,255,0.78); margin:0 auto;">
        ...
        interconnected continuum in which the heart, metabolism, and kidneys fail together â€”
    ...
    <div class="cmr-three-pillars reveal">
      <div class="cmr-pillar">
        ...
        <div class="cmr-pillar-items">Hypertension Â· Heart failure Â· Stroke Â· Coronary artery disease Â· Congenital heart disease</div>
      </div>
      <div class="cmr-pillar">
        <div class="cmr-pillar-letter">M</div>
        <div class="cmr-pillar-title">Metabolic</div>
        <div class="cmr-pillar-items">Obesity Â· Insulin resistance Â· Type 2 diabetes Â· Metabolic syndrome Â· Dyslipidaemia</div>
      </div>
      <div class="cmr-pillar">
        <div class="cmr-pillar-letter">R</div>
        <div class="cmr-pillar-title">Renal</div>
        <div class="cmr-pillar-items">Chronic kidney disease Â· Cardiorenal syndrome Â· Proteinuria Â· Renal hypertension</div>
      </div>
    </div>

    <div class="cmr-continuum reveal" style="margin-top:2.5rem;">
      <div class="cmr-node">
        <div class="cmr-node-icon">âš–ï¸</div>
        <div class="cmr-node-name">Obesity</div>
      </div>
      <div class="cmr-node">
        <div class="cmr-node-icon">ðŸ”‹</div>
      ...
      <div class="cmr-node">
        <div class="cmr-node-icon">âš¡</div>
        <div class="cmr-node-name">Stroke</div>
      </div>
    </div>

    <div class="cmr-tagline reveal">
      BHI screens for the whole continuum â€” because treating the heart alone is not enough.
      <span style="display:block; margin-top:0.75rem;">
        <a href="#" onclick="switchPage('education'); return false;" style="color:var(--gold); font-weight:700; text-decoration:underline;">Learn more about the CMR continuum â†’</a>
      </span>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="cmr-philosophy reveal">
      ...
      <p class="cmr-philosophy-statement">
        ...
        non-communicable disease challenge facing the Bono Region â€” and that it has never been
      ...
      <p class="cmr-philosophy-body">
        ...
        routinely treated as separate conditions â€” by separate specialists, in separate clinics,
      ...
      <p class="cmr-philosophy-core">
        ...
        It is the clinical framework upon which every BHI activity is built â€” screening,
    ...
    <div class="trust-cards reveal">
      <div class="trust-card">
        <div class="trust-icon">ðŸ‘¨â€âš•ï¸</div>
        <h3>Cardiologist-Led</h3>
        <p>Founded and led by Dr. Edward Bediako Mensah, MD â€” Consulting Cardiologist, Sunyani Teaching Hospital. Every clinical decision made at specialist level.</p>
      </div>
      <div class="trust-card">
        <div class="trust-icon">ðŸ“‹</div>
        <h3>Strategic Plan Completed</h3>
        <p>BHI operates a formal CMR Strategic Plan 2026â€“2028. Targets, timelines, and milestones are set. Outcomes are tracked every quarter across the full cardio-metabolic-renal continuum.</p>
      </div>
      <div class="trust-card">
        <div class="trust-icon">ðŸ›ï¸</div>
        <h3>Governance Structure Established</h3>
        <p>BHI has defined its governance framework â€” with board-level oversight, clinical advisory input, and financial accountability structures in place from the outset.</p>
      </div>
      <div class="trust-card">
        <div class="trust-icon">ðŸ—„ï¸</div>
        <h3>Registry Framework Developed</h3>
        <p>A longitudinal CMR registry architecture is established before the first patient is screened â€” tracking every individual from first contact to final outcome across cardiac, metabolic, and renal parameters.</p>
      </div>
      <div class="trust-card">
        <div class="trust-icon">ðŸ˜ï¸</div>
        <h3>Community-Focused Delivery</h3>
        <p>BHI's clinical model is built around the community â€” not the clinic. Care comes to the patient. Screening happens in villages, markets, and schools, not waiting rooms.</p>
      </div>
      <div class="trust-card">
        <div class="trust-icon">ðŸ”</div>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub">
        ...
        cardio-metabolic-renal care the most â€” in the communities where they live.
      </p>
    </div>
...
<section class="services-section" id="services">
  <div class="container">
    ...
    <div class="pillars reveal">
      <div class="pillar">
        <div class="pillar-icon">ðŸ©º</div>
        <h3>CMR Community Screening</h3>
        <p>Free cardio-metabolic-renal screening in villages, markets, and schools â€” heart, blood sugar, blood pressure, and kidney markers. No hospital visit required.</p>
      </div>
      <div class="pillar">
        <div class="pillar-icon">â¤ï¸</div>
        <h3>Precision Diagnostics</h3>
        <p>Echocardiography, ABPM, Holter monitoring, and metabolic panels at our Tier 2 hub â€” for every flagged patient across the CMR spectrum.</p>
      </div>
      <div class="pillar">
        <div class="pillar-icon">ðŸ«˜</div>
        <h3>Renal &amp; Metabolic Detection</h3>
        <p>Identifying chronic kidney disease, insulin resistance, and metabolic syndrome early â€” before they progress to heart failure or stroke.</p>
      </div>
      <div class="pillar">
        <div class="pillar-icon">ðŸ”—</div>
      ...
      <div class="pillar">
        ...
        <p>Radio, schools, community campaigns â€” building CMR health literacy across the Bono Region so communities recognise the warning signs early.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="ac-section" id="ac-education">
  <div class="container">
    <div class="text-center">
      ...
      <div class="section-divider"></div>
      <p class="section-sub">
        Science that speaks to everyone â€” in a language that makes sense in every community.
      </p>
    </div>
    <div class="ac-card reveal">
      <div class="ac-badge">ðŸŒ¡ï¸ The Overworked AC Concept</div>
      ...
      <p class="ac-body">
        ...
        <br><br>
        When you carry excess weight, your heart pumps harder â€” like an AC cooling a room that is too large.
        When your blood sugar is uncontrolled, your blood vessels thicken â€” like a clogged filter.
        When your kidneys are stressed, they can no longer remove waste efficiently â€” and the pressure backs up through the whole system.
      ...
      <div class="ac-stages">
        <div class="ac-stage">
          ...
          <div class="ac-stage-desc">Excess weight &amp; poor diet â†’ insulin resistance begins. No symptoms. Easily reversible.</div>
        </div>
        <div class="ac-stage">
          <div class="ac-stage-num">Stage 2</div>
          <div class="ac-stage-title">Rising Pressure</div>
          <div class="ac-stage-desc">Blood pressure climbs. Blood sugar rises. The system is straining â€” but still silent.</div>
        </div>
        <div class="ac-stage">
      ...
      <div class="ac-cta-line">
        BHI catches you at Stage 1 and Stage 2 â€” before the breakdown.
        <a href="#" onclick="switchPage('education'); return false;">Read the full CMR education resource â†’</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub">
        ...
        longitudinal CMR registry â€” tracking every patient from first contact to final outcome
        across the full cardio-metabolic-renal continuum.
      </p>
    </div>
    <div class="registry-cards reveal">
      <div class="registry-card">
        <div class="registry-card-icon">ðŸ«€</div>
        <h3>Echo Registry</h3>
        <p>All echo studies â€” findings, impression, referral outcome, follow-up. BHI's primary cardiac research platform.</p>
      </div>
      <div class="registry-card">
        <div class="registry-card-icon">ðŸ“ˆ</div>
        <h3>ABPM Registry</h3>
        <p>24-hr BP profiles, circadian phenotype, dipping pattern â€” connecting hypertension to its cardiac and renal consequences.</p>
      </div>
      <div class="registry-card">
        <div class="registry-card-icon">ðŸ’‰</div>
        <h3>Metabolic Registry</h3>
        <p>HbA1c, fasting glucose, BMI, waist circumference â€” a longitudinal metabolic burden map of the Bono Region.</p>
      </div>
      <div class="registry-card">
        <div class="registry-card-icon">ðŸ«˜</div>
        <h3>Renal Registry</h3>
        <p>Urine protein, eGFR trends, CKD staging â€” linking metabolic and cardiac risk to kidney outcomes. First of its kind in the region.</p>
      </div>
      <div class="registry-card">
        <div class="registry-card-icon">ðŸ”„</div>
        <h3>Referral Tracking</h3>
        <p>Every referral â€” initiated, completed, outcome recorded. Accountability data for donors and the Ghana Health Service.</p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub">
        ...
        â€” being built one district, one registry entry, and one referral at a time.
      </p>
    </div>
    <div class="roadmap-timeline reveal">
      ...
      <div class="roadmap-item roadmap-item--vision">
        ...
        <div class="roadmap-content">
          <h3>Sustain</h3>
          <p>Establish a self-sustaining regional CMR network â€” supporting early detection, referral coordination, outcomes tracking, and evidence-based policy development across the Bono Region.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="impact-section" id="impact">
  <div class="container">
    <div class="text-center">
      ...
      <h2 class="section-title">Year 1 Targets â€” 2026</h2>
      <div class="section-divider"></div>
      <p class="section-sub">
    ...
    <p class="impact-note">
      These are Year 1 targets from the BHI Strategic Plan 2026â€“2028.
    ...
    <div style="margin-top:3rem;padding-top:3rem;border-top:1px solid rgba(27,47,110,.1)">
      <p style="text-align:center;font-family:'Montserrat',sans-serif;font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--red);margin-bottom:1.5rem">ðŸ”´ Live Progress â€” Updated in Real Time</p>
      <div id="impact-stats-grid">
        <div class="bhi-loading">Loading live statisticsâ€¦</div>
      </div>
    </div>
  </div>
</section>
...
<section class="bhi-section alt reveal" id="outreach">
  <div class="bhi-container">
    <div class="text-center">
      <div class="section-tag">ðŸ“ In The Field</div>
    ...
    <div id="outreach-programs-grid">
      <div class="bhi-loading">Loading outreach programsâ€¦</div>
    </div>
  </div>
</section>
...
<section class="bhi-section reveal" id="field">
  <div class="bhi-container">
    <div class="text-center">
      <div class="section-tag">ðŸ“¸ From the Field</div>
    ...
    <div id="gallery-grid">
      <div class="bhi-loading">Loading galleryâ€¦</div>
    </div>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub">
        ...
        cardio-metabolic-renal health of 1.2 million people â€” with transparent reporting,
    ...
    <div class="tiers-grid reveal">
      <div class="tier-invest">
        <div class="tier-invest-header bronze">
          ...
          <div class="tier-usd">â‰ˆ USD 320</div>
        </div>
      ...
      <div class="tier-invest">
        <div class="tier-invest-header silver">
          ...
          <div class="tier-usd">â‰ˆ USD 645</div>
        </div>
        <div class="tier-invest-body">
          <div class="tier-suited">
            <strong>Suited for</strong>
      ...
      <div class="tier-invest">
        <div class="tier-invest-header gold">
          ...
          <div class="tier-usd">â‰ˆ USD 1,600</div>
        </div>
        <div class="tier-invest-body">
          <div class="tier-suited">
            <strong>Suited for</strong>
      ...
      <div class="tier-invest">
        <div class="tier-invest-header platinum">
          ...
          <div class="tier-usd">â‰ˆ USD 3,200</div>
        </div>
        <div class="tier-invest-body">
          <div class="tier-suited">
            <strong>Suited for</strong>
      ...
      <div class="tier-invest">
        <div class="tier-invest-header corporate">
          ...
          <div class="tier-usd">â‰ˆ USD 6,450+</div>
        </div>
        <div class="tier-invest-body">
          <div class="tier-suited">
            <strong>Suited for</strong>
    ...
    <div class="partner-cta-block reveal">
      <p>All partner contributions are acknowledged in writing. BHI commits to annual impact reporting â€” showing exactly what your investment achieved.</p>
    ...
    <div id="partner-form" style="max-width:640px;margin:3rem auto 0;background:#fff;border-radius:16px;padding:2.5rem;box-shadow:0 8px 32px rgba(27,47,110,.08)">
      ...
      <form data-bhi-form="partner">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
          <div style="margin-bottom:1rem">
            ...
            <select name="tier" style="width:100%;padding:.7rem .9rem;border:1.5px solid #e2e8f0;border-radius:7px;font-size:.9rem">
              <option value="bronze">Bronze â€” GHS 5,000</option>
              <option value="silver">Silver â€” GHS 10,000</option>
              <option value="gold">Gold â€” GHS 25,000</option>
              <option value="platinum">Platinum â€” GHS 50,000</option>
              <option value="corporate">Corporate Strategic â€” GHS 100,000+</option>
        ...
        <button type="submit" style="width:100%;background:#C8102E;color:#fff;border:none;padding:.9rem;border-radius:8px;font-family:'Montserrat',sans-serif;font-weight:700;font-size:.95rem;cursor:pointer">Send Partnership Enquiry â†’</button>
      </form>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="support-grid reveal">
      <div class="support-card">
        ...
        <div class="support-desc">Supports the screening supplies for a full community outreach day â€” blood pressure cuffs, glucose strips, ECG electrodes, and consumables.</div>
      </div>
      <div class="support-card">
        <div class="support-amount">GHS 2,000</div>
        <div class="support-desc">Supports community mobilisation â€” logistics, transport, and communications to bring a screening session to a remote village or market.</div>
      </div>
      <div class="support-card support-card--highlight">
        <div class="support-amount">GHS 5,000</div>
        <div class="support-desc">Supports a complete community outreach session â€” from arrival in the village to final triage, education, and referral for every flagged patient.</div>
      </div>
      <div class="support-card">
        <div class="support-amount">GHS 25,000</div>
        <div class="support-desc">Supports a district-scale screening programme â€” reaching multiple communities across one district with full CMR screening and diagnostic follow-up.</div>
      </div>
      <div class="support-card">
        <div class="support-amount">GHS 100,000+</div>
        <div class="support-desc">Supports strategic regional expansion â€” enabling BHI to establish a permanent presence, trained staff, and structured outreach cycles across multiple districts.</div>
      </div>
    </div>
...
<section class="closing-section" id="screening">
  <div class="container">
    ...
    <p>
      Whether you are a farmer in Dormaa, a teacher in Berekum, or a child growing up in Jaman North â€”
...
<section class="bhi-section alt" id="contact-form-section">
  <div class="bhi-container" style="max-width:680px">
    <div class="text-center" style="margin-bottom:2.5rem">
      ...
      <div class="section-divider"></div>
      <p class="section-sub">
        Questions about screening, partnerships, volunteering, or media enquiries â€”
    ...
    <div style="background:#fff;border-radius:16px;padding:2.5rem;box-shadow:0 8px 32px rgba(27,47,110,.08)">
      <form data-bhi-form="contact">
        ...
        <button type="submit" style="width:100%;background:#C8102E;color:#fff;border:none;padding:.9rem;border-radius:8px;font-family:'Montserrat',sans-serif;font-weight:700;font-size:.95rem;cursor:pointer">Send Message â†’</button>
      </form>
    </div>
  </div>
</section>
...
<footer id="contact">
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <div class="footer-contact">
        <a href="mailto:info@bonoheartinitiative.org">ðŸ“§ info@bonoheartinitiative.org</a>
        <a href="mailto:partner@bonoheartinitiative.org">ðŸ¤ partner@bonoheartinitiative.org</a>
        <a href="tel:+233243255462">ðŸ“ž +233 243 255 462</a>
        <a href="https://wa.me/233243255462">ðŸ’¬ WhatsApp Dr. Bediako Mensah</a>
      </div>
    </div>
  ...
  <div class="footer-bottom">
    <span>Â© 2026 Bono Heart Initiative. Bono Region, Ghana. All rights reserved.</span>
    <span>
      Founded by Dr. Edward Bediako Mensah, MD Â· Sunyani Teaching Hospital Â·
...
<section class="edu-hero">
  <div class="edu-hero-content">
    <div class="edu-badge">ðŸ«€ Cardio-Metabolic-Renal Health Education</div>
    ...
    <p>
      ...
      are not separate conditions. They are one story â€” and BHI is here to help you
  ...
  <div class="container">
    <div class="text-center">
      ...
      <p class="section-sub" style="color:rgba(255,255,255,0.78); margin:0 auto;">
        ...
        and kidneys damage each other in a vicious cycle â€” each organ's failure accelerating
    ...
    <div class="cmr-link-statement reveal">
      ...
      CMR disease demands one integrated approach â€” and that is exactly what BHI delivers."
    </div>
  </div>
</section>
...
<section class="pathway-section" id="pathway">
  <div class="container">
    ...
    <div class="section-divider"></div>
    <p class="section-sub">
      Most people reach hospital at Stage 6 or 7. BHI is designed to find you at Stage 1 or 2 â€”
    ...
    <div class="pathway-steps reveal">
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>When the body carries more fat than it can manage â€” especially around the abdomen â€” it begins to produce inflammatory signals that affect every organ. The heart works harder to pump blood through a larger body. Fat tissue becomes metabolically active in damaging ways.</p>
          ...
          <div class="step-bhi-note">BHI screens: BMI, waist circumference, weight-height ratio â€” at every community outreach.</div>
        </div>
      </div>
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>The body's cells stop responding to insulin properly. The pancreas compensates by producing more â€” but eventually it cannot keep up. Blood sugar begins to rise. Blood pressure creeps upward. Cholesterol patterns become dangerous.</p>
          <p>Metabolic syndrome â€” the cluster of high blood sugar, high blood pressure, abnormal lipids, and abdominal obesity â€” multiplies the risk of heart disease and kidney damage five-fold.</p>
          <div class="step-tags">
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>Blood sugar is persistently elevated. Glucose damages blood vessel walls throughout the body â€” in the eyes, the nerves, the kidneys, and the heart. The kidneys begin to leak protein (a sign of damage). The heart muscle itself becomes stiffer and less efficient.</p>
          <p>In Ghana, most people with diabetes are diagnosed at this stage â€” or later. In the Bono Region, most are never diagnosed at all.</p>
          <div class="step-tags">
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>Elevated blood pressure over years thickens and stiffens artery walls. The heart must pump against greater resistance, and enlarges as a result. Blood vessels supplying the kidneys narrow, reducing blood flow and triggering the kidneys to raise blood pressure further â€” a damaging feedback loop.</p>
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>Years of high blood pressure and high blood sugar scar the kidney filters permanently. The kidneys lose their ability to remove waste products and regulate fluid. Toxins accumulate. Fluid builds up in the lungs and legs â€” placing enormous strain on the heart.</p>
          <p>CKD and heart failure accelerate each other. This is called <strong>cardiorenal syndrome</strong> â€” and it is far more common in the Bono Region than anyone currently knows, because it has never been screened for.</p>
          <div class="step-tags">
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>Heart failure is Ghana's number one cause of cardiac hospital admission. In the Bono Region, most patients arrive in crisis â€” because no earlier intervention ever occurred.</p>
          <div class="step-tags">
          ...
          <div class="step-bhi-note">BHI's echocardiography detects heart enlargement and dysfunction before heart failure develops â€” at Tier 2 hub.</div>
        </div>
      </div>
      ...
      <div class="pathway-step">
        ...
        <div class="step-content">
          ...
          <p>In Ghana, stroke kills or disables in its prime. Most victims had elevated blood pressure for years before the event â€” and had never been told.</p>
          <div class="step-tags">
            <span class="step-tag danger">Emergency. Often fatal.</span>
            <span class="step-tag danger">Permanent disability risk</span>
            <span class="step-tag">Entirely preventable at Stage 1â€“4</span>
          </div>
          <div class="step-bhi-note">Every BHI community screening is stroke prevention. Catch the blood pressure before the stroke â€” not after.</div>
        </div>
      </div>
...
<section class="ac-section" id="overworked-ac">
  <div class="container">
    <div class="section-tag gold">ðŸŒ¡ï¸ The Overworked AC</div>
    ...
    <p class="section-sub">
      ...
      Here is the CMR disease story â€” told in a way that works everywhere.
    </p>
    ...
    <div class="ac-hero-card reveal">
      ...
      <p>
        ...
        When the system is healthy â€” the filters are clean, the power supply is stable, the rooms are not too big â€” the AC runs easily.
        <br><br>
        But when you carry excess weight, your heart must cool a bigger space. It works harder just to keep up.
        When your blood sugar is uncontrolled, the internal filters (your kidneys) become clogged â€” blocked with sugar deposits that damage the fine mesh that cleans your blood.
        ...
        <br><br>
        <strong>It overheats. It breaks down. And by the time the failure is obvious â€” the damage is already done.</strong>
        <br><br>
        Heart failure. Kidney failure. Stroke. These are not sudden events. They are the predictable end of a long overload.
        And the extraordinary truth is: <strong>every stage before breakdown is detectable, manageable, and often reversible</strong> â€” if you catch it in time.
      </p>
    </div>
    ...
    <div class="ac-grid reveal">
      <div class="ac-card">
        ...
        <p>The AC is cooling a space that is too large. It can manage â€” but it is running harder than it should be every single day.</p>
      </div>
      <div class="ac-card">
        <div class="ac-card-stage">The Blocked Filter</div>
        <h4>Insulin resistance &amp; rising blood sugar</h4>
        <p>The internal filters are getting clogged. Airflow is reduced. The system compensates â€” but efficiency is dropping.</p>
      </div>
      <div class="ac-card">
        <div class="ac-card-stage">The Unstable Power</div>
        <h4>High blood pressure â€” persistent, relentless</h4>
      ...
      <div class="ac-card">
        ...
        <p>The coolant pipes are corroded. Fluid backs up. The whole system is under pressure â€” and leaking.</p>
      </div>
      <div class="ac-card">
      ...
      <div class="ac-card" style="border-left-color: var(--success); background: rgba(46,139,87,0.05);">
        ...
        <p>BHI comes to your community and checks the system â€” blood pressure, blood sugar, heart, kidneys â€” before a breakdown becomes inevitable.</p>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="faq-list reveal">
      <div class="faq-item">
        ...
        <div class="faq-a">Yes â€” and this is the most important message BHI carries. CMR disease is silent for years. High blood pressure has no symptoms until a stroke occurs. Diabetes damages kidneys for a decade before pain begins. Heart failure announces itself only when the heart has already failed. Feeling fine means you are in the stage where intervention works best.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q">Is this only for older people?</div>
        <div class="faq-a">No. Hypertension is increasingly common in Ghanaians in their 30s. Obesity and insulin resistance are rising in young adults. BHI screens from age 18 upward â€” and conducts congenital heart disease screening in children. CMR disease does not wait for age.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q">My mother has diabetes. Does that mean I will get it too?</div>
        <div class="faq-a">Family history increases your risk â€” but it does not determine your outcome. Lifestyle, diet, activity, and early screening can dramatically reduce the probability of developing diabetes even with a strong family history. BHI's screening gives you the information to act before the condition develops.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q">What does BHI actually do when you come to screen me?</div>
        <div class="faq-a">At Tier 1 (community screening), BHI measures your blood pressure, blood glucose, BMI, and performs an ECG. If anything is flagged, you are invited to a Tier 2 session at our hub â€” where echocardiography, 24-hour BP monitoring, metabolic blood tests, and kidney function tests are performed. Everything is explained to you clearly. Nothing costs you anything.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q">Can CMR disease be treated or reversed?</div>
        <div class="faq-a">At early stages â€” absolutely. Obesity and insulin resistance can be reversed with lifestyle intervention. Blood pressure can be normalised with medication and lifestyle changes. Early kidney damage can be slowed or halted. The key is catching the disease in Stage 1, 2, or 3 â€” not Stage 6 or 7. That is the entire rationale for BHI's existence.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="edu-cta">
  <div class="container">
    ...
    <p>
      ...
      direction of your health â€” and protect everyone who depends on you.
    </p>
    <div class="cta-btns">
      <a href="#outreach" onclick="switchPage('home'); setTimeout(()=>document.getElementById('outreach').scrollIntoView({behavior:'smooth'}), 150); return false;" class="btn-primary">ðŸ©º Get Screened</a>
      <a href="#partners" onclick="switchPage('home'); return true;" class="btn-outline-white">Support the Mission</a>
      <a href="#" onclick="switchPage('home'); return false;" class="btn-outline-white">â† Back to BHI Homepage</a>
    </div>
  </div>
</section>
...
<footer>
  <div class="footer-bottom">
    <span>Â© 2026 Bono Heart Initiative. Bono Region, Ghana. All rights reserved.</span>
    <span>
      <a href="mailto:info@bonoheartinitiative.org">info@bonoheartinitiative.org</a> Â·
      <a href="mailto:partner@bonoheartinitiative.org">partner@bonoheartinitiative.org</a> Â·
      Founded by Dr. Edward Bediako Mensah, MD Â· Sunyani Teaching Hospital Â·
      <a href="/privacy">Privacy Policy</a>
    </span>
  </div>
...
<section class="founder-hero">
  <div class="founder-hero-content">
    <div class="hero-eyebrow">ðŸ‘¨â€âš•ï¸ Meet the Founder</div>
    <h1>Dr. <em>Edward Bediako Mensah</em></h1>
    <p class="founder-hero-title">Consulting Cardiologist Â· Sunyani Teaching Hospital Â· Founder, Bono Heart Initiative</p>
    <p>
    ...
    <div class="profile-grid reveal">
      <div class="profile-photo-wrap">
        <div class="profile-photo" style="border:none; background:none;">
          <img
            src="assets/img/dr-bediako-mensah.jpg"
      ...
      <div class="profile-content">
        ...
        <h3 class="story-h3">ELAM Cuba â€” Where It Began</h3>
        <p class="story-body">
          Dr. Bediako Mensah began his medical training at the <strong>Latin American School of Medicine (ELAM) in Cuba</strong> â€” a globally recognised institution founded on the principles of equity, prevention, and service to underserved communities.
        </p>
        <p class="story-body">
          At ELAM, healthcare was not viewed as something confined to hospitals. Physicians were taught to engage communities directly, identify disease early, and bring care closer to those who needed it most. This philosophy profoundly shaped his understanding of medicine â€” and never left him.
        </p>

        <p class="story-body story-body--personal">
          But this commitment to equity was not shaped by training alone. Growing up in Ghana, Dr. Bediako Mensah experienced first-hand the realities faced by people in underserved communities â€” the distances travelled to reach care, the costs that made specialist appointments impossible, the diagnoses that came too late because no system had ever reached the patient first. ELAM did not create this conviction. It gave it a framework, a language, and a path forward.
        </p>

        <h3 class="story-h3">Cardiocentro Ernesto Che Guevara â€” Specialist Training</h3>
        <p class="story-body">
          Following medical school, he pursued specialist cardiology training at the <strong>Cardiocentro Ernesto Che Guevara in Santa Clara, Cuba</strong> â€” one of the country's leading cardiovascular centres. There he gained advanced experience in cardiovascular diagnostics, heart failure management, structural heart disease, echocardiography, preventive cardiology, and the complexities of specialist cardiac care.
        </p>
        ...
        <p class="story-body">
          That experience revealed an important reality: the clinical problems were rarely the result of poor medicine. They were the result of late presentation â€” driven by distance, cost, and the absence of structured detection systems in communities.
        </p>

        <h3 class="story-h3">Returning to Ghana â€” The Observation That Could Not Be Ignored</h3>
        <p class="story-body">
          Returning to Ghana and working within the Bono Region reinforced this observation. Patients frequently travelled long distances for specialist evaluation â€” often presenting late, after years of undetected hypertension, diabetes, heart failure, congenital heart disease, or kidney disease. The need was clear. The system to address it did not yet exist.
        </p>

        <h3 class="story-h3">University Hospital Zurich â€” Building Systems That Last</h3>
        <p class="story-body">
          Years later, this vision was further deepened through advanced postgraduate cardiovascular systems training at the <strong>University Hospital Zurich</strong> â€” one of Europe's foremost academic medical centres â€” through the internationally recognised <strong>Postgraduate Course in Heart Failure (PCHF)</strong>. Dr. Bediako Mensah is currently enrolled in the programme and is expected to complete the <strong>Certificate of Advanced Studies (CAS)</strong> in 2027.
        </p>
        <p class="story-body">
        ...
        <div class="pchf-photo-block reveal">
          ...
          <div class="pchf-photo-caption">
            <div class="pchf-caption-icon">ðŸ“</div>
            <div class="pchf-caption-text">
              ...
              cardiovascular clinicians and health system leaders from across the world â€”
        ...
        <p class="story-body story-body--personal">
          Engaging on international cardiovascular platforms brought a further and important realisation. Global cardiovascular leadership is not reserved for large institutions or wealthy countries. The experiences of African clinicians working in under-resourced settings â€” the patterns of late presentation, the disease burden carried silently by communities without access to diagnostics, the solutions developed out of necessity â€” these are not peripheral to the global conversation. African experiences and African data deserve a central place in it. BHI's registry is, in part, a contribution to that conversation.
        </p>
  ...
  <div class="container">
    ...
    <div class="journey-steps reveal">
      <div class="journey-step">
        ...
        <p>A globally recognised institution founded on equity, prevention, and service to underserved communities. ELAM shaped the conviction that the doctor must go to the patient â€” not the other way around.</p>
      </div>
      <div class="journey-step">
      ...
      <div class="journey-step">
        <div class="journey-step-period">Postgraduate Training â€” Ongoing</div>
        <h3>University Hospital Zurich â€” PCHF (CAS expected 2027)</h3>
        <p>Advanced postgraduate cardiovascular systems training through the internationally recognised Postgraduate Course in Heart Failure (PCHF), University Hospital Zurich. Currently enrolled â€” Certificate of Advanced Studies (CAS) expected 2027. Focused on heart failure systems, registries, implementation science, multidisciplinary care, outcomes measurement, and sustainable cardiovascular programme development.</p>
      </div>
      <div class="journey-step">
        <div class="journey-step-period">Current Role</div>
        <h3>Consulting Cardiologist, Sunyani Teaching Hospital</h3>
        <p>Providing specialist cardiac care, echocardiography, ABPM monitoring, and cardiology inpatient management at the Bono Region's primary teaching hospital â€” while building BHI to serve the communities beyond its walls.</p>
      </div>
      <div class="journey-step">
        <div class="journey-step-period">2026 â€” Present</div>
        <h3>Founder, Bono Heart Initiative</h3>
        <p>The convergence of ELAM's community philosophy, Cardiocentro's specialist expertise, and Zurich's systems thinking â€” applied to one region, one mission, and 1.2 million people who deserve better.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="vision-points reveal">
      <div class="vision-point">
        <div class="vision-point-icon">ðŸŒ</div>
      ...
      <div class="vision-point">
        <div class="vision-point-icon">ðŸ“Š</div>
      ...
      <div class="vision-point">
        <div class="vision-point-icon">ðŸ˜ï¸</div>
      ...
      <div class="vision-point">
        <div class="vision-point-icon">âš–ï¸</div>
      ...
      <div class="vision-point">
        <div class="vision-point-icon">ðŸ¤</div>
        <h3>A Model for Ghana</h3>
        <p>BHI is designed to be replicable. If it works in the Bono Region, the model â€” community screening, CMR registries, structured referral â€” can be adopted across Ghana's underserved regions.</p>
      </div>
      <div class="vision-point">
        <div class="vision-point-icon">ðŸ‘¶</div>
        <h3>The Next Generation</h3>
        <p>Training community health workers in CMR literacy. Building a generation of Bono Region residents who understand their heart, their metabolism, and their kidneys â€” before disease takes hold.</p>
      </div>
    </div>
    <div class="vision-closing reveal">
      "I did not build this for recognition. I built it because the Bono Region deserves a doctor who shows up â€” and a system that stays."
      <br><span style="font-size:0.85rem; color:rgba(255,255,255,0.55); font-style:normal; font-weight:400; display:block; margin-top:0.5rem;">â€” Dr. Edward Bediako Mensah, MD</span>
    </div>
  </div>
</section>
...
<section class="founder-cta">
  <div class="container">
    ...
    <div class="cta-row">
      ...
      <a href="#" onclick="switchPage('home'); return false;" class="btn-secondary-outline">â† Back to Homepage</a>
    </div>
  </div>
</section>
  ...
  <div class="bhi-modal-box">
    ...
    <div class="bhi-modal-body">
      <form data-bhi-form="screening">
        ...
        <button type="submit" style="width:100%;background:#C8102E;color:#fff;border:none;padding:.9rem;border-radius:8px;font-family:'Montserrat',sans-serif;font-weight:700;font-size:.95rem;cursor:pointer">Confirm Registration â†’</button>
      </form>
    </div>
  </div>
</div>
